...
<body>
              ...
              <div class="d-flex flex-column gap-6">
                ...
                <div class="d-flex flex-column gap-3">
                  <ul class="header-menu list-unstyled mb-0 d-flex flex-column gap-2">
                    ...
                    <li class="header-item">
                      <a href="{{ url('/home/projects') }}" class="header-link active hstack gap-2 fs-7 fw-bold text-dark"><img
                          src="{{ asset('assets/images/svgs/secondary-leaf.svg') }}" alt="" width="20" height="20"
  ...
  <div class="page-wrapper overflow-hidden">
    ...
    <section class="banner-section banner-inner-section position-relative overflow-hidden d-flex align-items-end"
      style="background-image: url('{{ asset('assets/images/backgrounds/projects-banner.jpg') }}');">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 mb-7">
            <div class="portfolio d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="100"
              ...
              <div class="portfolio-img position-relative overflow-hidden">
                <img src="{{ asset('assets/images/portfolio/portfolio-img-5.jpg') }}" alt="" class="img-fluid w-100">
          ...
          <div class="col-lg-6 mb-7">
            <div class="portfolio d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="200"
              data-aos-duration="1000">
              <div class="portfolio-img position-relative overflow-hidden">
                <img src="{{ asset('assets/images/portfolio/portfolio-img-4.jpg') }}" alt="" class="img-fluid w-100">
                <div class="portfolio-overlay">
                  <a href="{{ url('/home/projects/projects-detail') }}"
                    class="position-absolute top-50 start-50 translate-middle bg-primary round-64 rounded-circle hstack justify-content-center">
                    <iconify-icon icon="lucide:arrow-up-right" class="fs-8 text-dark"></iconify-icon>
          ...
          <div class="col-lg-6 mb-7">
            <div class="portfolio d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="300"
              data-aos-duration="1000">
              <div class="portfolio-img position-relative overflow-hidden">
                <img src="{{ asset('assets/images/portfolio/portfolio-img-6.jpg') }}" alt="" class="img-fluid w-100">
                <div class="portfolio-overlay">
                  <a href="{{ url('/home/projects/projects-detail') }}"
                    class="position-absolute top-50 start-50 translate-middle bg-primary round-64 rounded-circle hstack justify-content-center">
                    <iconify-icon icon="lucide:arrow-up-right" class="fs-8 text-dark"></iconify-icon>
          ...
          <div class="col-lg-6 mb-7">
            <div class="portfolio d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="400"
              data-aos-duration="1000">
              <div class="portfolio-img position-relative overflow-hidden">
                <img src="{{ asset('assets/images/portfolio/portfolio-img-3.jpg') }}" alt="" class="img-fluid w-100">
                <div class="portfolio-overlay">
                  <a href="{{ url('/home/projects/projects-detail') }}"
                    class="position-absolute top-50 start-50 translate-middle bg-primary round-64 rounded-circle hstack justify-content-center">
                    <iconify-icon icon="lucide:arrow-up-right" class="fs-8 text-dark"></iconify-icon>
          ...
          <div class="col-lg-6 mb-7">
            <div class="portfolio d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="500"
              data-aos-duration="1000">
              <div class="portfolio-img position-relative overflow-hidden">
                <img src="{{ asset('assets/images/portfolio/portfolio-img-1.jpg') }}" alt="" class="img-fluid w-100">
                <div class="portfolio-overlay">
                  <a href="{{ url('/home/projects/projects-detail') }}"
                    class="position-absolute top-50 start-50 translate-middle bg-primary round-64 rounded-circle hstack justify-content-center">
                    <iconify-icon icon="lucide:arrow-up-right" class="fs-8 text-dark"></iconify-icon>
          ...
          <div class="col-lg-6 mb-7">
            <div class="portfolio d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="600"
              data-aos-duration="1000">
              <div class="portfolio-img position-relative overflow-hidden">
                <img src="{{ asset('assets/images/portfolio/portfolio-img-2.jpg') }}" alt="" class="img-fluid w-100">
                <div class="portfolio-overlay">
                  <a href="{{ url('/home/projects/projects-detail') }}"
                    class="position-absolute top-50 start-50 translate-middle bg-primary round-64 rounded-circle hstack justify-content-center">
                    <iconify-icon icon="lucide:arrow-up-right" class="fs-8 text-dark"></iconify-icon>
