...
<body>
  ...
  <div class="page-wrapper overflow-hidden">
    ...
    <section class="banner-section banner-inner-section position-relative overflow-hidden d-flex align-items-end"
      style="background-image: url('{{ asset('assets/images/backgrounds/projects-detail-banner.jpg') }}');">
      <div class="container">
      ...
      <div class="container">
        <div class="d-flex flex-column gap-5 gap-xl-11">
          <div class="d-flex flex-column gap-8">
            <a href="{{ url('/home/projects') }}" class="btn py-2 ps-3 pe-5" data-aos="fade-up" data-aos-delay="100"
              data-aos-duration="1000">
          ...
          <div class="row">
            <div class="col-12 mb-7" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
              <img src="{{ asset('assets/images/portfolio/portfolio-img-4.jpg') }}" alt="services" class="w-100 object-fit-cover">
            </div>
            <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
              <img src="{{ asset('assets/images/portfolio/portfolio-img-2.jpg') }}" alt="services" class="w-100 object-fit-cover">
            </div>
            <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
              <img src="{{ asset('assets/images/portfolio/portfolio-img-3.jpg') }}" alt="services" class="w-100 object-fit-cover">
            </div>
          </div>
        </div>
      </div>
